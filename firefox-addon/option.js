...
document.addEventListener('DOMContentLoaded', function () {
    ...
    browser.storage.sync.get(['AISERVER_URL'], function(storage){
    ...
    browser.storage.sync.get(['CHATSERVER_URL'], function(storage){
...
function submitForm() {
  ...
  browser.storage.sync.set({'AISERVER_URL':inputValue, 'CHATSERVER_URL':chatInputValue}, function(){
     // close();
