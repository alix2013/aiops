...
function showInformation(selectedText) {
  ...
  if (!infoDiv) {
    ...
    copyIcon.addEventListener("mousedown", function () {
      ...
      // copyToClipboard(selectedText);
      copyToClipboard(paragraph.innerText);
    });
    ...
    //   // chrome.runtime.sendMessage({ action: "copyToClipboard", text: selectedText });
    //   copyToClipboard(selectedText);
    // });
...
//   window.startX = e.clientX - icon.offsetLeft;
//   window.startY = e.clientY - icon.offsetTop;
// });

// document.addEventListener('mousemove', function(e) {
//   if(window.isMouseDown) {
//     icon.style.left = e.clientX - window.startX + 'px';
//     icon.style.top = e.clientY - window.startY + 'px';
//   }
// });
